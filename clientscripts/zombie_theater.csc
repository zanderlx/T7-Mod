...
eeroom_visionset_on( ent_player )
{
	...
	// Apex: Start - Use better visionset system
	/*
	...
	*/
	clientscripts\apex\_utility::visionset_activate(ent_player GetLocalClientNumber(), self.script_string);
	// Apex: End - Use better visionset system
}
...
eeroom_visionset_off( ent_player )
{
	// Apex: Start - Use better visionset system
	// VisionSetNaked( ent_player GetLocalClientNumber(), "zombie_theater", 0 );
	clientscripts\apex\_utility::visionset_deactivate(ent_player GetLocalClientNumber(), self.script_string);
	// Apex: End - Use better visionset system
}
...
custom_visionset_registration()
{
	...
	clientscripts\apex\_utility::visionset_register_info("theater_vision",	"zombie_theater",					0, 			0, 			0, 			true);
	clientscripts\apex\_utility::visionset_register_info("asylum_room",		"zombie_theater_eroom_asylum",		1, 			0, 			0, 			false);
	clientscripts\apex\_utility::visionset_register_info("pentagon_room",	"zombie_theater_erooms_pentagon",	1, 			0, 			0, 			false);
