...
custom_box_move_logic()
{
	...
	{
		maps\apex\_zm_weapons::default_box_move_logic();
		return;
	}
...
respin_box_thread(hacker)
{
	...
	maps\apex\_zm_weapons::unacquire_weapon_toggle( self.chest.chest_origin.weapon_string );
	self.chest.chest_origin thread maps\apex\_zm_weapons::treasure_chest_weapon_spawn(self.chest, hacker, true);
	...
	if(!flag("moving_chest_now"))
	{
		...
		self.chest thread maps\apex\_zm_weapons::treasure_chest_timeout();
	}
}
...
summon_box_thread(hacker)
{
	...
	self.chest thread maps\apex\_zm_weapons::show_chest();
	self.chest thread maps\apex\_zm_weapons::hide_rubble();
	...
	self.chest thread maps\apex\_zm_weapons::treasure_chest_think();
	...
	self.chest thread maps\apex\_zm_weapons::hide_chest();
	self.chest thread maps\apex\_zm_weapons::show_rubble();
}
