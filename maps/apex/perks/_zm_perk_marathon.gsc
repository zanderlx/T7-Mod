...
include_perk_for_level()
{
	...
	maps\apex\_zm_perks::register_perk_machine("marathon", false, &"ZOMBIE_PERK_MARATHON", 2000, "p7_zm_vending_marathon", "p7_zm_vending_marathon_on", "perk_light_marathon");
