...
include_perk_for_level()
{
	...
	maps\apex\_zm_perks::register_perk_machine("mule_kick", &"ZOMBIE_PERK_ADDITIONALPRIMARYWEAPON", 4000, "p7_zm_vending_three_gun", "p7_zm_vending_three_gun_on", "perk_light_mule_kick");
