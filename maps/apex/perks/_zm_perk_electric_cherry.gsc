...
{
	maps\apex\_zm_perks::register_perk("cherry", "minimap_icon_electric_cherry");
	maps\apex\_zm_perks::register_perk_bottle("cherry", undefined, undefined, 31);
	maps\apex\_zm_perks::register_perk_machine("cherry", false, &"ZOMBIE_PERK_ELECTRICCHERRY", 2000, "p6_zm_vending_electric_cherry_off", "p6_zm_vending_electric_cherry_on", "perk_light_green");
	maps\apex\_zm_perks::register_perk_threads("cherry", ::give_cherry, ::take_chery);
	maps\apex\_zm_perks::register_perk_sounds("cherry", "mus_perks_cherry_sting", "mus_perks_cherry_jingle", undefined);
...
electric_cherry_cooldown_timer(weapon)
{
	...
	if(self has_perk("speed_cola") || self HasPerk("specialty_fastreload"))
...
electric_cherry_reload_fx(fraction, laststand_effect)
{
	...
	self levelNotify("cherry_fx_cancel");
