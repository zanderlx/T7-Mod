...
include_powerup_for_level()
{
	...
	maps\apex\_zm_powerups::register_timed_powerup("double_points", false, "specialty_2x_zombies", "zombie_powerup_double_points_time", "zombie_powerup_double_points_time");
