...
{
	return is_in_array(level.zombie_lethal_grenade_list, weaponname);
}
...
{
	return is_in_array(level.zombie_tactical_grenade_list, weaponname);
}
...
{
	return is_in_array(level.zombie_placeable_mine_list, weaponname);
}
...
{
	return is_in_array(level.zombie_melee_weapon_list, weaponname);
}
...
{
	return is_in_array(level.zombie_equipment_list, weaponname);
}
...
is_offhand_weapon( weaponname )
{
	...
	if(maps\_zm_utility::is_weapon_riotshield(weaponname))
		return true;
	if(maps\_zm_utility::is_hero_weapon(weaponname))
		return true;
	if(maps\_zm_utility::is_flourish_weapon(weaponname))
		return true;
...
is_player_offhand_weapon( weaponname )
{
	...
	if(self maps\_zm_utility::is_player_riotshield(weaponname))
		return true;
	if(self maps\_zm_utility::is_player_hero_weapon(weaponname))
		return true;
	if(self is_player_lethal_grenade(weaponname))
		return true;
	if(self is_player_tactical_grenade(weaponname))
		return true;
	if(self is_player_placeable_mine(weaponname))
		return true;
	if(self is_player_melee_weapon(weaponname))
		return true;
...
{
	if(isdefined(level._zm_check_for_instakill_func))
		single_thread(self, level._zm_check_for_instakill_func, player, mod, hit_location);
}