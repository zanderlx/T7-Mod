...
give_placeable_mine(weapon_name)
{
...
take_placeable_mine(weapon_name)
{
	self set_player_placeable_mine("none");
	self SetActionSlot(level.zombie_vars["zombie_weapons_slot_mines"], "weapon", "none");
	self disable_placeable_mine_triggers(weapon_name);
}