...
init()
{
	...
	add_tesla_death_anim("zombie", %ai_zombie_tesla_death_a);
	add_tesla_death_anim("zombie", %ai_zombie_tesla_death_b);
	add_tesla_death_anim("zombie", %ai_zombie_tesla_death_c);
	add_tesla_death_anim("zombie", %ai_zombie_tesla_death_d);
	add_tesla_death_anim("zombie", %ai_zombie_tesla_death_e);

	add_tesla_crawl_death_anim("zombie", %ai_zombie_tesla_crawl_death_a);
	add_tesla_crawl_death_anim("zombie", %ai_zombie_tesla_crawl_death_b);
...
add_tesla_death_anim(zombie_type, anim_name)
{
	if(!isdefined(level._zombie_tesla_death))
		level._zombie_tesla_death = [];
	if(!isdefined(level._zombie_tesla_death[zombie_type]))
		level._zombie_tesla_death[zombie_type] = [];
	if(!IsInArray(level._zombie_tesla_death[zombie_type], anim_name))
		level._zombie_tesla_death[zombie_type][level._zombie_tesla_death[zombie_type].size] = anim_name;
}

add_tesla_crawl_death_anim(zombie_type, anim_name)
{
	if(!isdefined(level._zombie_tesla_crawl_death))
		level._zombie_tesla_crawl_death = [];
	if(!isdefined(level._zombie_tesla_crawl_death[zombie_type]))
		level._zombie_tesla_crawl_death[zombie_type] = [];
	if(!IsInArray(level._zombie_tesla_crawl_death[zombie_type], anim_name))
		level._zombie_tesla_crawl_death[zombie_type][level._zombie_tesla_crawl_death[zombie_type].size] = anim_name;
}
