...
player_teleporting( index )
{
	...
	if ( randomint( 100 ) > 24 && !IsDefined( level.eeroomsinuse ) ) // ww: chaning the frequency to 75%
	{
		loc = "eerooms";
...
eeroom_powerup_drop()
{
	...
	level thread maps\_zm_powerups::specific_powerup_drop( powerup_array[0], struct_array[0].origin );
}
