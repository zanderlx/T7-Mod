...
turn_area51_perks_on()
{
	...
	for( i = 0; i < machine2.size; i++ )
	{
		...
		//machine2[i] thread maps\apex\_zm_perks::perk_fx( "jugger_light" );
	}
...
electric_switch()
{
	...
	trig thread maps\apex\_zm_perks::vending_machine_trigger_think();
...
custom_add_weapons()
{
	maps\apex\_zm_weapons::add_zombie_weapon( "microwavegundw_zm",		"microwavegundw_upgraded_zm",			&"ZOMBIE_WEAPON_MICROWAVEGUN_DW", 				10,		"microwave",			"",		undefined );
	maps\apex\_zm_weapons::add_zombie_weapon( "zombie_quantum_bomb",		undefined,								&"ZOMBIE_WEAPON_SATCHEL_2000", 		2000,	"quantum",	"",		undefined );
}
...
moon_perk_lost( perk )
{
	self maps\apex\_zm_perks::update_perk_hud();
}
